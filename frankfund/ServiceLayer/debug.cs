        ...
        static void Main(string[] args)
        {
            ...
            /*
                Console Output:
                    Running Query:
                    --------------
                    SELECT MAX(SGID) AS maxSGID FROM frankfund.FrankFund.SavingsGoals
                    ...
                    Began on 2021-03-02 and ends on 2021-12-25
                    ...
                    --------------------------------
                    {"SGID":1,"Name":"Christmas Gift","GoalAmt":250.25,"ContrAmt":25.02,"Period":"Monthly","StartDate":"2021-03-02","EndDate":"2021-12-25"}

                    {"SGID":1,"Name":"Christmas Gift","GoalAmt":250.25,"ContrAmt":25.02,"Period":"Monthly","StartDate":"2021-03-02","EndDate":"2021-12-25"}

                    Running Insert Query:
                    ---------------------
                    INSERT INTO frankfund.FrankFund.SavingsGoals VALUES (1,"Christmas Gift",250.25,25.02,"Monthly","2021-03-02","2021-12-25")
            */
